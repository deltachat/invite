Object.assign((typeof window === 'undefined' ? module.exports : window).i18n = (typeof window === 'undefined' ? module.exports : window).i18n || {}, {
  ru: {
    ...
    DescriptionText: 'Delta Chat - это приложение для обмена сообщениями, которое работает через электронную почту.',
    FormBlurbText: 'Создайте инвайт-ссылку для Delta Chat',
    StepCodeText: 'Откройте Delta Chat, зайдите в раздел <b>QR-код → показать QR-инвайт код → Сохранить в буфер обмена</b>',
